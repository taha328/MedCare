...
public class FileAttenteRepository {
    ...
    private final String COLLECTION_NAME = "waitingList"; // Choose collection name
    ...
    public LiveData<List<FileAttente>> getFileAttenteForEtablissementStream(String etablissementId) {
        ...
        // Add ordering if needed, requires index
            ...
            if (snapshots != null) {
                for (QueryDocumentSnapshot doc : snapshots) {
                    try {
                        ...
                        file.setDocumentId(doc.getId()); // Assuming model has setDocumentId
        ...
        // Manage listener 'registration' lifecycle
        return liveData;
    }
    ...
    public Task<Void> update(@NonNull FileAttente fileAttente, @NonNull String documentId) {
        ...
        // Or use .update() with specific fields if needed
    }
