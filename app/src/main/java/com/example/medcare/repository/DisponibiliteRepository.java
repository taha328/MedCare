...
// Removed QuerySnapshot import as it's not needed in THIS file
...
public class DisponibiliteRepository {
    ...
    public LiveData<List<Disponibilite>> getDisponibilitesForProfessionalStream(String professionalId) {
        ...
        // NOTE: Add a mechanism to remove this listener when the LiveData is inactive
        // to prevent memory leaks, e.g., using a custom LiveData subclass.
            ...
            if (snapshots != null) {
                for (QueryDocumentSnapshot doc : snapshots) {
                    try {
                        ...
                        // Assuming ID is handled via auto-mapping or not needed in the list view
