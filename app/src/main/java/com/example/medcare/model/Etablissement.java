...
public class Etablissement {
    ...
    private String professionalOwnerId; // ID of the professional who owns/created this

    // Default no-argument constructor required by Firestore
    public Etablissement() {}

    // Keep parameterized constructor (optional, but useful)
