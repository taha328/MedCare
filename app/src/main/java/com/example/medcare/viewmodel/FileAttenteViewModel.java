...
import com.example.medcare.model.FileAttente; // Use Firestore-adapted model
import com.example.medcare.repository.FileAttenteRepository; // Use Firestore-adapted repo
...
public class FileAttenteViewModel extends ViewModel {
    ...
    private final MutableLiveData<String> _operationSuccessId = new MutableLiveData<>(); // Holds new ID on insert success
