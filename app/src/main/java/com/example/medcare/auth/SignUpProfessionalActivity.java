    ...
    private void saveProfessionalProfile(FirebaseUser user, String name, String license, String specialty) {
        ...
        db.collection("users").document(uid).set(userProfile)
                ...
                .addOnFailureListener(e -> {
                    ...
                    // Consider deleting the auth user here if profile save fails critically
                    // user.delete(); // Use with caution
                });
    }

    // Removed setPendingRoleMarker method as Cloud Functions are not used
